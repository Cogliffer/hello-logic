      ...
      <div class="container">
        ...
        <div id="article-nav" class="nav-collapse collapse-sidebar in collapse">
          <ul class="nav">
            ...
            <li><a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#pagetopright" class="back-to-top">Back to Top <i class="icon-angle-up icon2x"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
...
<li><a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#NonMonoForm">3. Non-monotonic formalisms</a>
   <ul>
   <li><a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#ClosWorlAssu">3.1 The closed-world assumption</a></li>
...
<h3 id="ConfReso">2.1 Conflict resolution</h3>
...
<h3 id="ReasUnreConf">2.2 Reasoning with unresolved conflicts</h3>
...
<h2 id="NonMonoForm">3. Non-monotonic formalisms</h2>
...
\equiv Pb)\) (&ldquo;<i>a</i> and <i>b</i> are indiscernible&rdquo;).
</p>
...
<h3 id="DefaLogi">3.3 Default logic</h3>
...
\(\rightarrow\) <i>flies</i>, <i>penguin</i> \(\rightarrow\)
...
<table class="cellpad-med vert-top hrules avoid-break centered">
<tr>
<td>\(\Pi\)</td>
<td>\(\phi \nc^S \psi\) iff</td>
<td>Structures</td> </tr> 
...
&ldquo;taking big steps&rdquo;, i.e., in such a way that for any \(M
...
Diamond: \(\mathbf{K}\) = {<i>Quaker</i> \(\nc\) <i>Pacifist</i>,
<i>Republican</i> \(\nc\) &not;<i>Pacifist</i>}. It seems desirable to
derive e.g. <i>Quaker</i> \(\wedge\) <i>worker</i> \(\nc\)
<i>Pacifist</i> since in view of \(\mathbf{K}\), being a worker is
<i>irrelevant</i> to the assertion <i>Quaker</i> \(\nc\)
<i>Pacifist</i>. Intuitively speaking, <i>Quaker</i> \(\nc\)
&not;<i>worker</i> should fail in which case Rational Monotony yields
<i>Quaker</i> \(\wedge\) <i>worker</i> \(\nc\) <i>Pacifist</i> in view
of <i>Quaker</i> \(\nc\) <i>Pacifist</i>. Hence, prima facie we may
...
\(\mathbf{K}\) hold for \(\nc\)). Unfortunately it is <i>not</i> the
case that <i>Quaker</i> \(\wedge\) <i>worker</i> \(\nc^{R}\)
<i>Pacifist</i>. The reason is simply that there are rational
consequence relations for which <i>Quaker</i> \(\nc\)
&not;<i>worker</i> and whence Rational Monotony does not yield the
desired <i>Quaker</i> \(\wedge\) <i>worker</i> \(\nc\)
<i>Pacifist</i>. Moreover, it has been shown that \(\nc^R\) is
identical to the preferential closure \(\nc^P\). </p>

<p>
In
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Lehmann:Magidor:1992">Lehmann and Magidor (1992)</a>
 a <i>Rational Closure</i> for conditional knowledge bases such as
...
to \(i\). \(\alpha\) has rank \(i+1\) if it doesn&rsquo;t have a rank
smaller or equal to \(i\) and it is consistent with
\(m(\mathbf{K}_{i+1})\). </p>

<p>
In our example <i>Quaker \(\wedge\) worker</i> has rank 0, just like
<i>Quaker</i>. This is stricly less than the rank 1 of <i>Quaker
\(\wedge\) &not;Pacifist</i> and <i>Quaker \(\wedge\) worker
\(\wedge\) &not;Pacifist</i>. This means that the desired
<i>Quaker</i> \(\wedge\) <i>worker</i> \(\nc\) <i>Pacifist</i> is in
the Rational Closure of our \(\mathbf{K}\). </p>

<p>
A system equivalent to Rational Closure has been independently
proposed under the name <i>system <b>Z</b></i> based on
\(\epsilon\)-semantics in
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Pearl:1990">Pearl (1990)</a>.
 </p>

<p>
One may consider it a drawback of Rational Closure that it suffers
from the Drowning Problem (see
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#drowning">above</a>).
 To see this consider the following conditional knowledge base
<b>KL</b>: </p>

<blockquote>
<img src="logic-course.png" alt="logic-course.png" width="250" />
</blockquote>

<p>
We have the following ranks: </p>
...
\(l\nc f\) is not in the rational closure of \(\mathbf{KL}\). </p>

<p>
This problem has been tackled in
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Lehmann:1995">Lehmann (1995)</a>
 with the formalism <i>Lexicographic Closure</i>. Rougly the idea is
...
<tr>
  ...
  <td class="org-right">0</td>
  <td class="org-right">0</td>
  <td class="org-left">\(M_8\)</td>
  <td class="org-left">\(l \nc c:1\)</td> </tr>
</table>

<p>
The best model of \(l \wedge f\) is \(M_3\) since it doesn&rsquo;t violate
...
Closure. Altogether, what avoids the drowning problem in Lehmann&rsquo;s
approach is a combination between specificity handling and a
<i>quantitative rationale</i> according to which interpretations are
preferred that violate less conditionals. </p>
...
Suppose moreover we know that <i>Party</i> \(\wedge\) ((&not;
<i>Anne</i> \(\wedge\) &not; <i>Phil</i>) \(\vee\) &not;
<i>Frank</i>). In view of this fact not all three assertions hold. At
...
Lexicographic Closure of \(\mathbf{K}\) which contains </p>

<ul class="org-ul">

<li><i>Party</i> \(\wedge\) ((&not; <i>Anne</i> \(\wedge\) &not;
<i>Phil</i>) \(\vee\) &not; <i>Frank</i>) \(\nc\) &not;<i>Frank</i>
and </li>
...
<p>
Similar quantitative considerations play a role in the <i>Maximum
Entropy Approach</i> in
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Goldzsmidt:et-al:1993">Goldzsmidt et al. (1993)</a>
...
<h3 id="AssuBaseAppr">3.6 Assumption-based approaches</h3>

<p>
In a family of approaches defeasible inferences are encoded as
material inferences with explicit assumptions: </p>

<blockquote>

<p>
[&dagger;] &emsp;&emsp; \((\phi \wedge \mathsf{as}) \supset \psi\)
</p>
</blockquote>
...
&ldquo;as much as possible&rdquo;. There are various ways to give a
more precise meaning to this. </p>

<p>
One such approach is offered by <i>Adaptive Logics</i>
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Batens:2007">Batens 2007</a>,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Strasser:2014">Stra&szlig;er 2014</a>). An adaptive logic AL 
is given by a triple consisting of </p>

<ul class="org-ul">

<li>a <i>lower limit logic</i> LLL with a consequence relation
\(\vdash\) that is reflexive, monotonic, satisfies Cut, and is compact
(If \(\Gamma \vdash \phi\) then there is a finite \(\Gamma' \subseteq
\Gamma\) such that \(\Gamma' \vdash \phi\)); </li>

<li>a set of <i>abnormalities</i> \(\Omega\) containing formulas which
are to be interpretated &ldquo;as false as much as possible&rdquo;;
and </li>

<li>an <i>adaptive strategy</i> in view of which the phrase &ldquo;as
false as much as possible&rdquo; will be disambiguated. </li>
</ul>
...
inferences by means of the following scheme: </p>

<blockquote>

<p>
[&Dagger;] &emsp;&emsp; Where \(\mathsf{ab}\) is an abnormal formula
...
<p>
Where \(\mathsf{as} = \neg \mathsf{ab}\), the antecedent of [&Dagger;]
is equivalent to \(\vdash (\phi \wedge \mathsf{as}) \supset \psi\)
which is [&dagger;] above (under the classical meaning of \(\neg,
\wedge\), and \(\vee\)). </p>

<p>
Examples of concrete classes of adaptive logics are: </p>

<ul class="org-ul">

<li><i>Inconsistency-Adaptive Logics</i>
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Batens:1980">Batens 1980</a>,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Batens:1999">Batens 1999</a>,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Priest:1991">Priest 1991</a>):
...
is non-explosive (\(p, {\sim} p \nvdash q\)) and for which disjunctive
syllogism doesn&rsquo;t hold (\(\phi \vee \psi, {\sim} \phi \nvdash \psi\)).
Let \(\Omega\) consist of \(\sim\)-contradictions in logical atoms
(\(p \wedge {\sim} p\)). Then we have \(p \vee q, {\sim} p \vdash q
\vee \mathsf{ab}\) where \(\mathsf{ab} = p \wedge {\sim}p\). This
means, disjunctive syllogism can be applied on the assumption that
there is no \(\sim\)-contradiction in \(p\). This way LLL is
significantly strengthened in a non-monotonic way. </li>

<li><i>Adaptive Logics of Inductive Generalizations</i>: Let LLL be CL
and consider a \(\Omega\) that contains, for instance, formulas of the
form \(\exists x P(x) \wedge \neg \forall x P(x)\). Then we have, for
example, \(P(a) \vdash \forall x P(x) \vee \mathsf{ab}\) where
\(\mathsf{ab} = \exists x P(x) \wedge \neg \forall x P(x)\). This
means we inductively generalize from \(P(a)\) to \(\forall x P(x)\)
based on the assumption that the abnormality \(\mathsf{ab}\) does not
hold. (This is a simplified account compared to the more subtle logics
presented in
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Batens:2011">Batens (2011)</a>.)
 </li>

<li> There are numerous adaptive logics for other defeasible reasoning
forms such as abductive reasoning, normative reasoning, belief
revision, diagnosis, etc. </li>
</ul>

<p>
Adaptive logics implement the idea behind [&Dagger;] syntactically in
terms of a <i>dynamic proof theory</i>. A dynamic proof from the
premise set \(\{P(a), \neg P(b)\}\) for an adaptive logic of inductive
generalizations may look as follows: </p>

<table class="cellpad-small vert-top centered"> 
<tr>
  <td class="right">1.</td>
  <td>\(P(a)\)</td>
  <td>PREM</td>
...
conditional) follows scheme [&Dagger;] where \(\mathsf{ab}\) is pushed
...
are &#10003;-<i>marked</i> as retracted. This is clearly the case if
...
derived without defeasible steps (i.e., on the condition &empty;).
...
lines may cause the retraction of previous lines of a proof. </p>

<p>
Not all cases of retraction are of this straightforward kind. Various
<i>adaptive strategies</i> come with marking mechanisms to handle more
complicated cases such as the one in the following proof: </p>
...
<tr>
  <td class="right">4.</td>
  <td>\(\forall x P(x) \vee \forall x Q(x)\)</td>
  <td>1; RC</td>
  <td>\(\{\exists x P(x) \wedge \neg \forall x
P(x)\}\)</td> </tr>
<tr>
...
condition &empty;. However, both are part of the (minimal) disjunction
of abnormalities derived at line 6. According to one strategy, the
<i>minimal abnormality strategy</i>, the premises are interpreted in
...
<i>reliability strategy</i>, is more cautious. According to it any
line that involves an abnormality in its condition that is part of a
minimal disjunction of abnormalities derived on the condition &empty;
...
at an unmarked line <i>l</i> in an adaptive proof from a premise set
\(\Gamma\) is considered a <i>consequence of \(\Gamma\)</i> if any
extension of the proof in which <i>l</i> is marked is further
extendable so that the line is unmarked again. </p>

<p>
Such a consequence relation can equivalently be expressed semantically
in terms of a preferential semantics (see Section
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#SeleSema">Selection semantics</a>).
 Given an LLL-model \(M\) we can identify its <i>abnormal part</i>
...
sets. In
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Makinson:2003">Makinson (2003)</a>
 it was developed under the name <i>default assumptions</i>. Given a
set of assumptions \(\Xi\), </p>
...
abnormalities \(\Omega\)
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#VanDePutte:2013">Van De Putte 2013</a>).
 </p>

<p>
<i>Conditional Entailment</i> is another assumption-based approach
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Geffner:Pearl:1992">Geffner and Pearl 1992</a>).
...
<i>assumption-based theory</i> \(T' = (\Delta', \Gamma', \Lambda)\) as
follows: </p>

<ul class="org-ul">

<li>For each \(\phi_i \rightarrow \psi_i \in \Delta\) we introduce a
designated assumption constant \(\pi_i\) and encode \(\phi_i
\rightarrow \psi_i\) by \(\phi_i \wedge \pi_i \supset \psi_i\). The
former is just our scheme [&dagger;] while the latter makes sure that
assumptions are &mdash;by default&mdash; considered to hold. </li>

<li>The set of defaults \(\Delta'\) is \(\{\phi_i \rightarrow \pi_i
\mid i \in I\}\) and our background knowledge becomes \(\Gamma' =
...
&lt;. Models are then compared as follows: </p>
...
\setminus Ab(M)\) for which \(\pi_i &lt; \pi_j\). </p>
</blockquote>

<p>
The idea is: \(M\) is preferred over \(M'\) if every assumption
\(\pi_i\) that doesn't hold in \(M\) but that holds in \(M'\) is
&lsquo;compensated for&rsquo; by a more specific assumption \(\pi_j\) that holds
in \(M\) but that doesn&rsquo;t hold in \(M'\). </p>

<p>
For this to work, &lt; has to include specificity relations among
assumptions. Such orders &lt; are called <i>admissible</i> relative to
...
\(\pi_k \in \Pi\) for which \(\pi_k &lt; \pi_j\). </p>
...
\(Ab(M_1)\) &mdash;namely \(\pi_2\)&mdash; there is \(\pi_1 \in
Ab(M_2) \setminus Ab(M_1)\) and \(\pi_2 &lt; \pi_1\). </p>
...
models \(M\) of \(\Gamma' \cup \Lambda\), \(M \models \phi\). </p>
</blockquote>
...
inferences are <i>contrapositable</i>. Clearly, if \(\phi \wedge \pi
...
&empty; is an admissible ordering which means that for instance a
...
consequent doesn&rsquo;t contradict with \(\Xi\)) it is applied. There is
disagreement among scholars whether and when contraposition is a
desirable property for defeasible inferences (e.g.,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Caminada:2008">Caminada 2008</a>,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Prakken:2012">Prakken 2012</a>). </p>

<h2 id="NonMonoLogiHumaReas">4. Non-monotonic logic and human reasoning</h2>

<p>
In view of the fact that test subjects seem to perform very poorly in
various paradigmatic reasoning tests (e.g., Wason&rsquo;s Selection Task
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Wason:1966">Wason 1966</a>)
 or the Supression Task
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Byrne:1989">Byrne 1989</a>)),
...
on NMLs have been argued to be more appropriate. </p>

<p>
This resulted in the rise of a new probabilistic paradigm
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Oaksford:Chater:2007">Oaksford and Chater 2007</a>,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Pfeifer:Douven:2014">Pfeifer and Douven 2014</a>) where 
...
decidedly anti-logicist
 terms,<sup>[<a href="notes.html#note-7" id="ref-7">7</a>]</sup>
...
close connections especially to probabilistic accounts of NML
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Over:2009">Over 2009</a>,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Pfeifer:Kleiter:2009b">Pfeifer and Kleiter 2009</a>).
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Politzer:Bonnefon:2009">Politzer and Bonnefon 2009</a>
...
Another argument for the relevance of NML is advocated in
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Stenning:Van-Lambalgen:2008">Stenning and Van Lambalgen (2008)</a>
 who distinguish between reasoning <i>to</i> and reasoning <i>from</i>
...
reasoning takes place and to the agent&rsquo;s goals. When establishing a
logical form agents choose&mdash;inter alia&mdash;a formal language, a
...
background of empirical studies
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Pelletier:Elio:1997">Pelletier and Elio 1997</a>).
 </p>

<p>
Various studies investigate their test subjects&rsquo; tendency to reason
...
principles such as Cautious Monotony
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Schurz:2005">Schurz 2005</a>,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Neves:et-al:2002">Neves et al. 2002</a>,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Pfeifer:Kleiter:2005c">Pfeifer and Kleiter 2005</a>)
 and Rational Monotony
 (<a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Neves:et-al:2002">Neves et al. 2002</a>),
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Benferhat:et-al:2005">Benferhat et al. (2005)</a> report mixed results. Specificity considerations play a
role in the reasoning process of test subjects in
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Schurz:2005">Schurz (2005)</a>,
 whereas according to
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Ford:Billington:2000">Ford and Billington (2000)</a>
 they do not.
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Benferhat:et-al:2005">Benferhat et al. (2005)</a>
...
still suggest a preference for the former. </p>

<p>

 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Pelletier:Elio:1994">Pelletier and Elio (1994)</a>
 investigate various relevant factors that influence subjects&rsquo;
...
proposed in
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Lifschitz:1989">Lifschitz (1989)</a>.
 It is, for instance, observed that the exceptional status of an
object <i>A</i> with respect to some default is more likely to spread
to other objects if they share properties with <i>A</i> that may play
...
neural networks (see
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Stenning:Van-Lambalgen:2008">Stenning and Van Lambalgen (2008)</a>,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Garcez-et-al:2009">Garcez et al (2009)</a>,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Hoelldobler-Kalinke:1994">H&ouml;lldobler and Kalinke (1994)</a>
 for
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#ClosWorlAssu">logic programming</a>
 with closed world assumptions,
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Besold-et-al:2017">Besold et al (2017)</a>
 for input/output logic, and
 <a href="https://plato.stanford.edu/entries/logic-nonmonotonic/#Leitgeb:2001">Leitgeb (2001)</a>
...
(<i>i</i>) material adequacy; (<i>ii</i>) formal properties; and
(<i>iii</i>) complexity. A non-monotonic formalism is materially
...
concerning the framework. </p>

<p>
There is a potential tension between (<i>i</i>) and (<i>ii</i>): the
desire to capture a broad range of intuitions can lead to <i>ad
hoc</i> solutions that can sometimes undermine the desirable formal
...
consideration (<i>i</i>) and has relied on a rich and well-chosen
array of examples. Of course, there is some question as to whether any
single framework can aspire to be universal in this respect. </p>

<p>
More recently, researchers have started paying attention to
consideration (<i>ii</i>), looking at the extent to which NMLs have
...
generate a well-behaved consequence relation. </p>
...
progress has been slowest in coming. </p>
</div>
...
<li><a name="Adams:1975">Adams, Ernest&nbsp;W.</a>, 1975. <em>The
Logic of Conditionals</em>. Dordrecht: D. Reidel Publishing Co.</li>

<li><a name="Alferes:et-al:1995">Alferes, Jose&nbsp;Julio, Damasio,
Carlos&nbsp;Viegas, &amp; Pereira, Luis&nbsp;Moniz</a>, 1995. A Logic
Programming System for Non-monotonic Reasoning.
<em>Journal of Automated Reasoning</em>, 14(1): 93&ndash;147.</li>

<li><a name="Aliseda:2017">Aliseda, Atocha</a>, 2017. The logic of
abduction: An introduction. In <em>Springer Handbook of Model-Based
Science</em>, Magnani, Lorenzo and Bertolotti, Tommaso
(Edts.). pp. 219&ndash;230.</li>

<li><a name="Antonelli:1997">&ndash;&ndash;&ndash;</a>,
1997. Defeasible inheritance on cyclic networks. <em>Artificial
Intelligence</em>, 92(1): 1&ndash;23.</li>

<li><a name="Antonelli:1999">Antonelli, Gian Aldo</a>, 1999. A
directly cautious theory of defeasible consequence for default logic
via the notion of general extension. <em>Artificial Intelligence</em>,
109(1): 71&ndash;109.</li>

<li><a name="Arieli:Avron:2000">Arieli, Ofer, &amp; Avron, Arnon</a>,
2000. General Patterns for Nonmonotonic Reasoning: From Basic
Entailments to Plausible Relations. <em>Logic Journal of the
IGPL</em>, 8: 119&ndash;148.</li>

<li><a name="Arieli:Strasser:2015">Arieli, Ofer and Stra&szlig;er,
Christian</a>, 2015. Sequent-Based Logical
Argumentation. <em>Argument and Computation</em>, 1(6):
73&ndash;99.</li>

<li><a name="Asher:Morreau:1991">Asher, Nicholas, &amp; Morreau,
Michael</a>, 1991. Commonsense entailment: A modal theory of
nonmonotonic reasoning. In <em>Logics in AI</em>, Berlin: Springer,
pp.  1&ndash;30.</li>

<li><a name="Batens:1980">Batens, Diderik</a>, 1980. Paraconsistent
extensional propositional logics. <em>Logique at Analyse</em>,
90&ndash;91: 195&ndash;234.</li>

<li><a name="Batens:1999">&ndash;&ndash;&ndash;</a>,
1999. Inconsistency-Adaptive Logics. In <em>Logic at Work. Essays
Dedicated to the Memory of Helena Rasiowa</em>, Heidelberg, New York:
Physica Verlag (Springer), pp. 445&ndash;472.</li>

<li><a name="Batens:2004">&ndash;&ndash;&ndash;</a>, 2004. The need for
adaptive logics in epistemology. In <em>Logic, epistemology, and the
unity of science</em>. Berlin: Springer, pp.  459&ndash;485.</li>

<li><a name="Batens:2007">&ndash;&ndash;&ndash;</a>, 2007. A Universal Logic
Approach to Adaptive Logics. <em>Logica Universalis</em>, 1:
221&ndash;242.</li>

<li><a name="Batens:2011">&ndash;&ndash;&ndash;</a>, 2011. Logics for
qualitative inductive generalization. <em>Studia Logica</em>, 97(1):
pp. 61&ndash;80.</li>

<li><a name="Beirlaen:et:al:2018">Beirlaen, Mathieu, Heyninck, Jesse,
Pardo, Pere, &amp; Stra&szlig;er, Christian</a>, 2018. Argument strength in
formal argumentation. <em>IfCoLog Journal of Logics and their
Applications</em>, 5(3): 629&ndash;675.</li>

<li><a name="Benferhat:et:al:1993">Benferhat, Salem, Cayrol,
Claudette, Dubois, Didier, Lang, Jerome, &amp; and Prade, Henri</a>,
1993. Inconsistency management and prioritized syntax-based
entailment. In <em>Proceedings of IJCAI 1993</em>, pp.
640&ndash;645.</li>

<li><a name="Benferhat:et-al:1997">Benferhat, Salem, Dubier, Didier,
&amp; Prade, Henri</a>, 1997. Some Syntactic Approaches to the
Handling of Inconsistent Knowledge Basis: A Comparative Study. Part
I: The Flat Case.
<em>Studia Logica</em>, 58: 17&ndash;45.</li>

<li><a name="Benferhat:et-al:1999">&ndash;&ndash;&ndash;</a>,
1999. Possibilistic and standard probabilistic semantics of
conditional knowledge bases. <em>Journal of Logic and
Computation</em>, 9(6): 873&ndash;895.</li>

<li><a name="Benferhat:et-al:2005">Benferhat, Salem, Bonnefon,
Jean&nbsp;F., &amp; da&nbsp;Silva&nbsp;Neves, Rui</a>, 2005. An
overview of possibilistic handling of default reasoning, with
experimental studies. <em>Synthese</em>, 146(1&ndash;2):
53&ndash;70.</li>

<li><a name="Besnard:Hunter:2009">Besnard, P. and A. Hunter</a>
2009. Argumentation based on classical logic. In <em>Argumentation in
Artificial Intelligence</em>,  I. Rahwan and G. Simari (eds.), 
Berlin: Springer.</li>

<li><a name="Besold-et-al:2017">Besold, Tarek R., Garcez, Artur
d&rsquo;Avila, Stenning, Keith, van der Torre, Leendert, Lambalgen, Michiel
van</a>, 2017. Reasoning in Non-Probabilistic Uncertainty: Logic
Programming and Neural-Symbolic Computing As Examples. <em>Minds and
Machines</em>, 27(1): 37&ndash;77.</li>

<li><a name="Bochman:2018">Bochman, Alexander</a>,
2018. Argumentation, Nonmonotonic Reasoning and Logic. In
<em>Handbook of Formal Argumentation</em> Vol. 1. Eds. P. Baroni, D.
Gabbay, M. Giacomin, &amp; L. van der Torre. pp.2887&ndash;2926</li>

<li><a name="Boutilier:1990">Boutilier, Craig</a>, 1990. Conditional
Logics of Normality as Modal Systems. <em>AAAI</em> (Volume 90),
pp. 594&ndash;599.</li>

<li><a name="Brewka:Eiter:2000">Brewka, Gerhard, &amp; Eiter,
Thomas</a>, 2000. Prioritizing Default Logic. In <em>Intellectics and
Computational Logic</em>, Applied Logic Series (Volume 19),
Dordrecht: Kluwer, 27&ndash;45.</li>

<li><a name="Byrne:1989">Byrne, Ruth&nbsp;M.J.</a>, 1989. Suppressing
valid inferences with conditionals.
<em>Cognition</em>, 31(1): 61&ndash;83.</li>

<li><a name="Caminada:2008">Caminada, M.</a>, 2008. On the issue of
contraposition of defeasible rules.
<em>Frontiers in Artificial Intelligence and Applications</em>, 172:
109&ndash;115.</li>

<li><a name="Delgrande:et-al:2004">Delgrande, James, Schaub, Torsten,
Tompits, Hans, &amp; Wang, Kewen</a>, 2004. A classification and
survey of preference handling approaches in nonmonotonic
reasoning. <em>Computational Intelligence</em>, 20(2):
308&ndash;334.</li>

<li><a name="Delgrande:1987">Delgrande, James&nbsp;P.</a>, 1987. A
first-order conditional logic for prototypical properties.
<em>Artificial Intelligence</em>, 33(1): 105&ndash;130.</li>

<li><a name="Delgrande:1998">&ndash;&ndash;&ndash;</a>, 1998. On
first-order conditional logics. <em>Artificial Intelligence</em>,
105(1): 105&ndash;137.</li>

<li><a name="Delgrande:Schaub:2000">Delgrande, James&nbsp;P, &amp;
Schaub, Torsten</a>, 2000. Expressing preferences in default
logic. <em>Artificial Intelligence</em>, 123(1): 41&ndash;87.</li>

<li><a name="Dubois:Prade:1990">Dubois, Didier, &amp; Prade,
Henri</a>, 1990. An introduction to possibilistic and fuzzy
logics. In
<em>Readings in Uncertain Reasoning</em>. San Francisco: Morgan
Kaufmann Publishers Inc., pp. 742&ndash;761.</li>

<li><a name="Dung:1995">Dung, Phan&nbsp;Minh</a>, 1995. On the
Acceptability of Arguments and its Fundamental Role in Nonmonotonic
Reasoning, Logic Programming and n-Person Games.
<em>Artifical Intelligence</em>, 77: 321&ndash;358.</li>

<li><a name="Dung:et-al:2009">Dung, P.M., Kowalski, R.A., &amp; Toni,
F.</a>, 2009. Assumption-based argumentation. <em>Argumentation in
Artificial Intelligence</em>, 199&ndash;218.</li>

<li><a name="Pelletier:Elio:1994">Elio, Ren&eacute;e, &amp; Pelletier,
Francis&nbsp;Jeffry</a>, 1994. On Relevance in Nonmonotonic Reasoning:
Some Empirical Studies.  In Russ, Greiner, &amp; Devika, Subramanian
(eds.), <em>Relevance: AAAI 1994 Fall Symposium Series</em>. Palo
Alto: AAAI Press, pp.  64&ndash;67.</li>

<li><a name="Ford:2004">Ford, Marilyn</a>, 2004. System LS: A
Three-Tiered Nonmonotonic Reasoning System.
<em>Computational Intelligence</em>, 20(1): 89&ndash;108.</li>

<li><a name="Ford:Billington:2000">Ford, Marilyn, &amp; Billington,
David</a>, 2000. Strategies in human nonmonotonic
reasoning. <em>Computational Intelligence</em>, 16(3):
446&ndash;468.</li>

<li><a name="Friedman:Halpern:1996">Friedman, Nir, &amp; Halpern,
Joseph&nbsp;Y.</a>, 1996. Plausibility measures and default
reasoning. <em>Journal of the ACM</em>, 48: 1297&ndash;1304.</li>

<li><a name="Friedman:et-al:2000">Friedman, Nir, Halpern,
Joseph&nbsp;Y., &amp; Koller, Daphne</a>, 2000. First-order
conditional logic for default reasoning revisited.
<em>ACM Trans. Comput. Logic</em>, 1(October): 175&ndash;207.</li>

<li><a name="Gabbay:et-al:1994">Dov, Gabbay, Hogger, C., &amp;
Robinson, J. (eds.)</a>, 1994. <em>Handbook of Logic in Artificial
Intelligence and Logic Programming</em> (Volume 3), Oxford and New
York: Oxford University Press.</li>

<li><a name="Gabbay:1985">Gabbay, Dov&nbsp;M.</a>, 1985. Theoretical
foundations for non-monotonic reasoning in expert systems. <em>Logics
and models of concurrent systems</em>. New York: Springer-Verlag,
pp. 439&ndash;457. </li>

<li><a name="Garcez-et-al:2009">Garcez, Artur S. d&rsquo;Avila, Lamb, Lu&iacute;s
C., Gabbay, Dov</a>, 2009. Neural-symbolic cognitive
reasoning. Springer.</li>

<li><a name="Geffner:Pearl:1992">Geffner, Hector, &amp; Pearl,
Judea</a>, 1992. Conditional entailment: bridging two approaches to
default reasoning. <em>Artifical Intelligence</em>, 53(2&ndash;3):
209&ndash;244.</li>

<li><a name="Gelfond:Lifschitz:1988">Gelfond, Michael, &amp;
Lifschitz, Vladimir</a>, 1988. The stable model semantics for logic
programming. In
<em>ICLP/SLP</em> (Volume 88), pp. 1070&ndash;1080.</li>

<li><a name="Gilio:2002">Gilio, Angelo</a>, 2002. Probabilistic
reasoning under coherence in System P. <em>Annals of Mathematics and
Artificial Intelligence</em>, 34(1&ndash;3): 5&ndash;34.</li>

<li><a name="Ginsberg:1994">Ginsberg, Matthew&nbsp;L.</a>, 1994. <em>Essentials
of Artificial Intelligence</em>. San Francisco: Morgan Kaufmann
Publishers Inc.</li>

<li><a name="Ginsberg:1987">&ndash;&ndash;&ndash; (ed.)</a>,
1987. <em>Readings in nonmonotonic reasoning</em>. San Francisco:
Morgan Kaufmann.</li>

<li><a name="Giordano:et-al:2009">Giordano, Laura, Gliozzi, Valentina,
Olivetti, Nicola, &amp; Pozzato, Gian&nbsp;Luca</a>, 2009. Analytic
tableaux calculi for KLM logics of nonmonotonic reasoning. <em>ACM
Transactions on Computational Logic (TOCL)</em>, 10(3): 18.</li>

<li><a name="Goldszmidt:Pearl:1992">Goldszmidt, Mois&eacute;s, &amp;
Pearl, Judea</a>, 1992. Rank-based Systems: A Simple Approach to
Belief Revision, Belief Update, and Reasoning about Evidence and
Actions. In
<em>Proceedings of the Third International Conference on Knowledge
Representation and Reasoning</em>. San Francisco: Morgan Kaufmann, pp.
661&ndash;672.</li>

<li><a name="Goldzsmidt:et-al:1993">Goldzsmidt, Mois&eacute;s, Morris,
Paul, &amp; Pearl, Judea</a>, 1993. A Maximum Entropy Approach to
Nonmonotonic Reasoning. <em>IEEE Transactions on Pattern Analysis and
Machine Intelligence</em>, 15(3): 220&ndash;232.</li>

<li><a name="Hoelldobler-Kalinke:1994">H&ouml;lldobler, Steffen and
Kalinke, Yvonne</a>, 1994. Towards a new massible parallel
computational model for logic programming. In <em>Proceedings of the
Workshop on Combining Symbolic and Connectionist Processing
ECAI</em>, pp. 68&ndash;77.</li>

<li><a name="Horty:1994">Horty, John&nbsp;F.</a>, 1994. Some direct
theories of nonmonotonic inheritance. In Gabbay, Dov&nbsp;M., Hogger,
Christopher&nbsp;J., &amp; Robinson, J.&nbsp;A.  (eds.), <em>Handbook
of Logic in Artificial Intelligence and Logic Programming, Volume 3:
Nonmonotonic Reasoning and Uncertain Reasoning</em>. Oxford: Oxford
University Press, pp.  111&ndash;187.</li>

<li><a name="Horty:2002">&ndash;&ndash;&ndash;</a>, 2002. Skepticism and
floating conclusions. <em>Artifical Intelligence</em>,
135(1&ndash;2): 55&ndash;72.</li>

<li><a name="Horty:2007">&ndash;&ndash;&ndash;</a>, 2007. Defaults with
Priorities. <em>Journal of Philosophical Logic</em>, 36:
367&ndash;413.</li>

<li><a name="Konolige:1988">Konolige, Kurt</a>, 1988. On the relation
between default and autoepistemic logic.
<em>Artifical Intelligence</em>, 35(3): 343&ndash;382.</li>

<li><a name="Koons:2017">Koons, Robert</a>, 2017. Defeasible
Reasoning. In <em>The Stanford Encyclopedia of Philosophy</em>
(Spring 2017 Edition), Edward N. Zalta (ed.), URL =
&lt;<a href="https://plato.stanford.edu/archives/win2017/entries/reasoning-defeasible/">https://plato.stanford.edu/archives/win2017/entries/reasoning-defeasible/</a>&gt;.</li>

<li><a name="Kraus:et-al:1990">Kraus, Sarit, Lehmann, Daniel, &amp;
Magidor, Menachem</a>, 1990. Nonmonotonic Reasoning, Preferential
Models and Cumulative Logics. <em>Artifical Intelligence</em>, 44:
167&ndash;207.</li>

<li><a name="Kripke:1975">Kripke, Saul</a>, 1975. Outline of a Theory
of Truth. <em>Journal of Philosophy</em>, 72: 690&ndash;716.</li>

<li><a name="Lehmann:1995">Lehmann, Daniel&nbsp;J.</a>, 1995. Another
Perspective on Default Reasoning. <em>Annals of Mathematics and
Artificial Intelligence</em>, 15(1): 61&ndash;82.</li>

<li><a name="Lehmann:Magidor:1990">Lehmann, Daniel&nbsp;J., &amp;
Magidor, Menachem</a>, 1990. Preferential logics: the predicate
calculus case. In
<em>Proceedings of the 3rd conference on Theoretical aspects of
reasoning about knowledge</em>, San Francisco: Morgan Kaufmann
Publishers Inc., pp. 57&ndash;72.</li>

<li><a name="Lehmann:Magidor:1992">&ndash;&ndash;&ndash;</a>,
1992. What does a conditional knowledge base entail? <em>Artificial
Intelligence</em>, 55(1): 1&ndash;60.</li>

<li><a name="Leitgeb:2001">Leitgeb, Hannes</a>, 2001. Nonmonotonic
reasoning by inhibition nets. <em>Artifical Intelligence</em>,
128(May): 161&ndash;201.</li>

<li><a name="Liao:et:al:2018">Liao, Beishui, Oren, Nir, van der Torre,
Leendert, &amp; Villata, Serena</a>, 2018. Prioritized norms in
formal argumentation. <em>Journal of Logic and Computation</em>,
29(2): 215&ndash;240.</li>

<li><a name="Lifschitz:1989">Lifschitz, Vladimir</a>, 1989. Benchmark
problems for formal nonmonotonic reasoning. In
<em>Non-Monotonic Reasoning</em>. Berlin: Springer, pp.
202&ndash;219.</li>

<li><a name="Lin:Shoham:1990">Lin, Fangzhen, &amp; Shoham, Yoav</a>,
1990. Epistemic semantics for fixed-points non-monotonic logics. In
<em>Proceedings of the 3rd Conference on Theoretical Aspects of
Reasoning About Knowledge (TARK&rsquo;90)</em>, Pacific Grove, CA: Morgan
Kaufmann Publishers Inc, pp. 111&ndash;120.</li>

<li><a name="Lukaszewicz:1988">Lukaszewicz, Witold</a>,
1988. Considerations on default logic: an alternative approach.
<em>Computational intelligence</em>, 4(1): 1&ndash;16.</li>

<li><a name="Makinson:1994">Makinson, David</a>, 1994. General
patterns in nonmonotonic reasoning. In: <em>Handbook of Logic in
Artificial Intelligence and Logic Programming, vol. III</em>,
D. Gabbay, C. Hogger, J.A. Robinson (eds.), pp. 35&ndash;110, Oxford:
Oxford University Press.</li>

<li><a name="Makinson:2003">&ndash;&ndash;&ndash;</a>, 2003. Bridges between
classical and nonmonotonic logic. <em>Logic Journal of IGPL</em>,
11(1): 69&ndash;96.</li>

<li><a name="Makinson:G&auml;rdenfors:1991">Makinson, David, &amp;
G&auml;rdenfors, Peter</a>, 1991. Relations between the logic of
theory change and nonmonotonic logic. <em>The logic of theory
change</em>, Berlin: Springer, pp.  183&ndash;205.</li>

<li><a name="Makinson:Schlechta:1991">Makinson, David, &amp;
Schlechta, Karl</a>, 1991. Floating conclusions and zombie paths: two
deep difficulties in the &ldquo;directly skeptical&rdquo; approach to
defeasible inheritance nets. <em>Artifical Intelligence</em>, 48(2):
199&ndash;209.</li>

<li><a name="McCarthy:1980">McCarthy, J.</a>, 1980. Circumscription
&ndash; A Form of Non-Monotonic Reasoning.
<em>Artifical Intelligence</em>, 13: 27&ndash;29.</li>

<li><a name="Modgil-Prakken:2013">Modgil, Sanjay and Prakken,
Henry</a>, 2013. A general account of argumentation with preferences.
<em>Artificial Intelligence</em>, 195, 361&ndash;397.</li>

<li><a name="Moore:1984">Moore, Robert&nbsp;C.</a>,
1984. Possible-World Semantics for Autoepistemic Logic. In
<em>Proceedings of the Workshop on non-monotonic reasoning</em>, AAAI,
pp. 344&ndash;354.</li>

<li><a name="Moore:1985">&ndash;&ndash;&ndash;</a>, 1985. Semantical
considerations on nonmonotonic logic. <em>Artifical
Intelligence</em>, 25(1): 75&ndash;94.</li>

<li><a name="Neves:et-al:2002">Neves, Rui Da&nbsp;Silva, Bonnefon,
Jean-Fran&ccedil;ois, &amp; Raufaste, Eric</a>, 2002. An empirical
test of patterns for nonmonotonic inference.
<em>Annals of Mathematics and Artificial Intelligence</em>,
34(1&ndash;3): 107&ndash;130.</li>

<li><a name="Nute:1994">Nute, D.</a>, 1994. Defeasible
logics. In <em>Handbook of Logic in Artificial Intelligence and Logic
Programming</em> (Vol. 3). Oxford: Oxford University Press,
pp. 353&ndash;395.</li>

<li><a name="Oaksford:Chater:2007">Oaksford, Mike, &amp; Chater,
Nick</a>, 2007. <em>Bayesian rationality the probabilistic approach
to human reasoning</em>. Oxford: Oxford University Press.</li>

<li><a name="Oaksford:Chater:2009">&ndash;&ndash;&ndash;</a>, 2009. Pr&eacute;cis of Bayesian rationality: The
probabilistic approach to human reasoning. <em>Behavioral and Brain
Sciences</em>, 32(01): 69&ndash;84.</li>

<li><a name="EO:ras">Orlowska, Ewa (ed.)</a>, 1999. <em>Logic at
Work. Essays Dedicated to the Memory of Helena
Rasiowa</em>. Heidelberg, New York: Physica Verlag (Springer).</li>

<li><a name="Over:2009">Over, David&nbsp;E.</a>, 2009. New paradigm
psychology of reasoning. <em>Thinking &amp; Reasoning</em>, 15(4):
431&ndash;438.</li>

<li><a name="Pearl:1988">Pearl, Judea</a>, 1988. <em>Probabilistic
reasoning in intelligent systems: networks of plausible
inference</em>. San Francisco: Morgan Kaufmann.</li>

<li><a name="Pearl:1989">&ndash;&ndash;&ndash;</a>, 1989. Probabilistic
semantics for nonmonotonic reasoning: a survey.  In <em>Proceedings
of the first international conference on Principles of knowledge
representation and reasoning</em>. San Francisco: Morgan Kaufmann
Publishers, pp. 505&ndash;516.</li>

<li><a name="Pearl:1990">&ndash;&ndash;&ndash;</a>, 1990. System Z: a natural
ordering of defaults with tractable applications to nonmonotonic
reasoning. In <em>TARK &rsquo;90: Proceedings of the 3rd conference on
Theoretical aspects of reasoning about knowledge</em>. San Francisco:
Morgan Kaufmann Publishers, pp.  121&ndash;135.</li>

<li><a name="Pelletier:Elio:1997">Pelletier, Francis&nbsp;Jeffry,
&amp; Elio, Ren&eacute;e</a>, 1997. What should default reasoning be,
by default? <em>Computational Intelligence</em>, 13(2):
165&ndash;187.</li>

<li><a name="Pfeifer:Douven:2014">Pfeifer, Niki, &amp; Douven,
Igor</a>, 2014. Formal Epistemology and the New Paradigm Psychology
of Reasoning. <em>Review of Philosophy and Psychology</em>, 5(2):
199&ndash;221.</li>

<li><a name="Pfeifer:Kleiter:2005c">Pfeifer, Niki, &amp; Kleiter,
Gernot&nbsp;D.</a>, 2005. Coherence and nonmonotonicity in human
reasoning.
<em>Synthese</em>, 146(1&ndash;2): 93&ndash;109.</li>

<li><a name="Pfeifer:Kleiter:2009b">Pfeifer, Niki, &amp; Kleiter,
Gernot&nbsp;D.</a>, 2009. Mental probability logic. <em>Behavioral
and Brain Sciences</em>, 32(01): 98&ndash;99.</li>

<li><a name="Politzer:Bonnefon:2009">Politzer, Guy, &amp; Bonnefon,
Jean-Fran&ccedil;ois</a>, 2009. Let us not put the probabilistic cart
before the uncertainty bull. <em>Behavioral and Brain Sciences</em>,
32(01): 100&ndash;101.</li>

<li><a name="Pollock:1991">Pollock, John</a>, 1991. A Theory of
Defeasible Reasoning. <em>International Journal of Intelligent
Systems</em>, 6: 33&ndash;54.</li>

<li><a name="Pollock:1995">&ndash;&ndash;&ndash;</a>, 1995. <em>Cognitive
Carpentry</em>, Cambridge, MA: Bradford/MIT Press.</li>

<li><a name="Pollock:2008">&ndash;&ndash;&ndash;</a>, 2008. Defeasible
Reasoning. In <em>Reasoning: Studies of Human Inference and its
Foundations</em>, J. E. Adler and L. J. Rips (eds.), Cambridge:
Cambridge University Press, pp. 451&ndash;470.</li>

<li><a name="Poole:1985">Poole, David</a>, 1985. On the Comparison of
Theories: Preferring the Most Specific Explanation. In <em>IJCAI</em>
(Volume 85), pp. 144&ndash;147.</li>

<li><a name="Prakken:2010">Prakken, Henry</a>, 2010. An abstract
framework for argumentation with structured arguments. <em>Argument
&amp; Computation</em>, 1(2): 93&ndash;124.</li>

<li><a name="Prakken:2012">&ndash;&ndash;&ndash;</a>, 2012. Some reflections
on two current trends in formal argumentation.  In A. Artikis, et
al. (ed.), <em>Logic Programs, Norms and Action</em>. Dordrecht:
Springer, pp. 249&ndash;272.</li>

<li><a name="Prakken:2018">&ndash;&ndash;&ndash;</a>, 2018. Historical
overview of formal argumentation. In <em> Handbook of formal
argumentation</em> (Vol. 1). Eds. P. Baroni, D. Gabbay, M.  Giacomin,
&amp; L. van der Torre. London: College Publications.
pp.43&ndash;141</li>

<li><a name="Prakken:Vreeswijk:2002">Prakken, Henry, &amp; Vreeswijk,
Gerard A.&nbsp;W.</a>, 2002. <em>Logics for Defeasible
Argumentation</em> (Vol. 4), Dordrecht: Kluwer,
pp. 219&ndash;318.</li>

<li><a name="Priest:1991">Priest, Graham</a>, 1991. Minimally
inconsistent LP. <em>Studia Logica</em>, 50(2): 321&ndash;331.</li>

<li><a name="Reiter:1980">Reiter, Raymond</a>, 1980. A Logic for
Default Reasoning. <em>Artifical Intelligence</em>, 13:
81&ndash;132.</li>

<li><a name="Rescher:Manor:1970">Rescher, Nicholas &amp; Manor,
Ruth</a>, 1970. On inference from inconsistent premises. <em>Theory
and Decision</em>, 1: 179&ndash;217</li>

<li><a name="Rott:2013">Rott, Hans</a>, 2013. Two concepts of
plausibility in default reasoning.
<em>Erkenntnis</em>, 79(S6): 1219&ndash;1252.</li>

<li><a name="Schurz:2005">Schurz, Gerhard</a>, 2005. Non-monotonic
reasoning from an evolution-theoretic perspective: Ontic, logical and
cognitive foundations.
<em>Synthese</em>, 146(1&ndash;2): 37&ndash;51.</li>

<li><a name="Shoham:1987">Shoham, Yoav</a>, 1987. A Semantical
Approach to Nonmonotonic Logics. In Ginsberg,
M.&nbsp;L. (ed.), <em>Readings in Non-Monotonic Reasoning</em>. Los
Altos, CA: Morgan Kaufmann, pp. 227&ndash;249. </li>

<li><a name="Simari:Loui:1992">Simari, Guillermo&nbsp;R, &amp; Loui,
Ronald&nbsp;P.</a>, 1992. A mathematical treatment of defeasible
reasoning and its implementation. <em>Artificial intelligence</em>,
53(2): 125&ndash;157.</li>

<li><a name="Spohn:1988">Spohn, Wolfgang</a>, 1988. Ordinal
conditional functions: A dynamic theory of epistemic
states. In <em>Causation in Decision, Belief Change and
Statistics</em>, W. L. Harper, &amp; B. Skyrms (Eds.), Springer, pp.
105&ndash;134.</li>

<li><a name="Stalnaker:1993">Stalnaker, Robert</a>, 1993. A note on
non-monotonic modal logic. <em>Artificial Intelligence</em>, 64(2):
183&ndash;196.</li>

<li><a name="Stalnaker:1994">&ndash;&ndash;&ndash;</a>, 1994. What is a
nonmonotonic consequence relation? <em>Fundamenta Informaticae</em>,
21(1): 7&ndash;21.</li>

<li><a name="Stein:1992">Stein, Lynn Andrea</a>, 1992. Resolving
ambiguity in nonmonotonic inheritance hierarchies.
<em>Artificial Intelligence</em>, 55(2): 259&ndash;310.</li>

<li><a name="Stenning:Van-Lambalgen:2008">Stenning, Keith, &amp;
Van&nbsp;Lambalgen, Michiel</a>, 2008. <em>Human reasoning and
cognitive science</em>. Cambridge, MA: MIT Press.</li>

<li><a name="Strasser:2014">Stra&szlig;er, Christian</a>,
2014. <em>Adaptive Logic and Defeasible Reasoning. Applications in
Argumentation, Normative Reasoning and Default Reasoning</em> (Trends
in Logic, Volume 38). Dordrecht: Springer.</li>

<li><a name="Touretzky:et-al:1991">Touretzky, David&nbsp;S., Thomason,
Richmond&nbsp;H., &amp; Horty, John&nbsp;F.</a>, 1991. A Skeptic&rsquo;s
Menagerie: Conflictors, Preemptors, Reinstaters, and Zombies in
Nonmonotonic Inheritance. In <em>IJCAI</em>, pp.  478&ndash;485
of.</li>

<li><a name="VanDePutte:2013">Van De&nbsp;Putte, Frederik</a>,
2013. Default Assumptions and Selection Functions: A Generic
Framework for Non-monotonic Logics. In <em>Advances in Artificial
Intelligence and Its Applications</em>, Dordrecht: Springer, pp.
54&ndash;67.</li>

<li><a name="Verheij:1996">Verheij, Bart</a>, 1996. <em>Rules,
Reasons, Arguments. Formal Studies of Argumentation and Defeat</em>,
Ph.D. thesis, Universiteit Maastricht.</li>

<li><a name="Wason:1966">Wason, P.&nbsp;C.</a>, 1966. Reasoning. in
B. Foss (ed.), <em>New horizons in psychology I</em>, Harmondsworth:
Penguin, pp. 135&ndash;151.</li>
</ul>
...
<td><a href="https://plato.stanford.edu/cgi-bin/encyclopedia/archinfo.cgi?entry=logic-nonmonotonic" target="other">How to cite this entry</a>.</td>
</tr>

<tr>
<td><img src="../../symbols/sepman-icon.jpg" alt="sep man icon" /></td>
<td><a href="https://leibniz.stanford.edu/friends/preview/logic-nonmonotonic/" target="other">Preview the PDF version of this entry</a> at the
 <a href="https://leibniz.stanford.edu/friends/" target="other">Friends of the SEP Society</a>.</td>
</tr>

<tr>
<td><img src="../../symbols/inpho.png" alt="inpho icon" /></td>
<td><a href="https://www.inphoproject.org/entity?sep=logic-nonmonotonic&amp;redirect=True" target="other">Look up topics and thinkers related to this entry</a>
 at the Internet Philosophy Ontology Project (InPhO).</td>
</tr>

<tr>
<td><img src="../../symbols/pp.gif" alt="phil papers icon" /></td>
<td><a href="https://philpapers.org/sep/logic-nonmonotonic/" target="other">Enhanced bibliography for this entry</a>
...
<p>
 ...
 <a href="../modeltheory-fo/">model theory: first-order</a>
...
<br />
<a href="http://rub.academia.edu/ChristianStrasser" target="other">Christian Strasser</a>
&lt;<a href="m&#97;ilto:Christian&#37;2eStrasser&#37;40ruhr-uni-bochum&#37;2ede"><em>Christian<abbr title=" dot ">&#46;</abbr>Strasser<abbr title=" at ">&#64;</abbr>ruhr-uni-bochum<abbr title=" dot ">&#46;</abbr>de</em></a>&gt;<br />
G. Aldo Antonelli
